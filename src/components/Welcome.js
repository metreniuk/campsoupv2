...
const Welcome = () => (
  <Wrapper>
    <Content>
      ...
      <Description>
          С.У.П. - Система Управления Программой лагеря, созданная,
          чтобы помочь координаторам на этапе планирования заезда.
          С.У.П. содержит постоянно пополняемую базу данных с играми,
